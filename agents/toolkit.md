...
3. **Determine the model** — typically `github-copilot/gpt-5.5` for complex subagent tasks. Primary agents should NOT specify a `model:` — they inherit the user's currently selected model.
