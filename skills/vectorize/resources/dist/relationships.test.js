...
`;
            ...
            const mainCalls = relationships.filter(r => r.relationshipType === 'calls' && r.sourceName === 'main');
...
`;
            ...
            const relationships = await extractRelationships(files);
            const calls = relationships.filter(r => r.relationshipType === 'calls' && r.sourceName === 'compute');
...
`;
            ...
            const relationships = await extractRelationships(files);
            const calls = relationships.filter(r => r.relationshipType === 'calls' && r.sourceName === 'fetchData');
...
`;
            ...
            const relationships = await extractRelationships(files);
            const processCalls = relationships.filter(r => r.relationshipType === 'calls' && r.sourceName === 'process');
...
`;
            ...
            const appImports = relationships.filter(r => r.relationshipType === 'imports' && r.sourceFile === 'src/app.ts');
            expect(appImports.length).toBe(1);
            // Check function calls
            const calculateCalls = relationships.filter(r => r.relationshipType === 'calls' && r.sourceName === 'calculate');
