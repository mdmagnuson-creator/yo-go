...
import os from 'os';
import { detectModules, estimateSummaryCost, buildModuleSummaryPrompt, buildProjectSummaryPrompt, loadSummaries, saveSummaries, needsSummaryRefresh, searchSummaries, generateSummaries, } from './summaries.js';
describe('summaries', () => {
    let tempDir;
    beforeEach(() => {
...
`,
    ...
    describe('estimateSummaryCost', () => {
        ...
        it('should scale cost with module count', () => {
            ...
            const largeModules = Array(10).fill(null).map((_, i) => ({
                name: `module${i}`,
                path: `src/module${i}`,
                files: [],
                exports: [],
    ...
    describe('buildProjectSummaryPrompt', () => {
        ...
        it('should limit modules in overview', () => {
            const modules = Array(25).fill(null).map((_, i) => ({
                name: `module${i}`,
                path: `src/module${i}`,
                files: ['a.ts'],
                exports: [],
    ...
    describe('generateSummaries', () => {
        ...
        it('should limit modules to maxModules option', async () => {
            const modules = Array(30).fill(null).map((_, i) => ({
                name: `module${i}`,
                path: `src/module${i}`,
